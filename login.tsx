...
// Code from: https://github.com/react-native-google-signin/google-signin/blob/master/example/src/App.tsx
// Troubleshooting: https://github.com/react-native-google-signin/google-signin/blob/master/docs/android-guide.md#getting-developer_error-error-message-on-android-when-trying-to-login
...
export default class GoogleSigninSampleApp extends Component<{}, State> {
    ...
    _configureGoogleSignIn() {
        GoogleSignin.configure({
            webClientId: '850295598135-aa6uk5jlkavk729us4nalst4rp8np18q.apps.googleusercontent.com',
            offlineAccess: false,
